...
with col2:
    st.title("Analista de Dados Jr | Python | SQL | Excel | Streamlit | Power BI")

st.write(
    """
        -  Com experiência em Python, SQL, Excel, Streamlit e Power BI, atuo na análise, visualização e interpretação de dados para apoiar a tomada de decisões estratégicas.
        ...
        - 📊 Power BI e Streamlit: Criação de dashboards interativos e relatórios dinâmicos para visualização de dados.
